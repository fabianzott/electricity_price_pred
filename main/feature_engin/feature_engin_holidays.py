...
#     # holidays_df['actual_pmi'] = pd.to_numeric(holidays_df['actual_pmi'], errors='coerce')
...
#     holidays_df['holiday'] = scaler.fit_transform(holidays_df[['holiday']])
